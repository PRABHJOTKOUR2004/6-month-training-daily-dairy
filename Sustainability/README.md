...
- **🏠 Hostel Mode & Assistant** — Unified hostel dashboard featuring a mess plate builder, daily menu logs, macro analysis, nutrition quality score, protein gap detection, weekly grocery lists, survival mode ranking, and a hostel health score tracker
...
- **🤖 Coach** — Multi-functional coaching chat that answers both general fitness queries (water, protein, weight forecasts, health scores) and hostel-specific questions (mess menu adjustments, budget-fit food suggestions, allergies, and dislikes)
